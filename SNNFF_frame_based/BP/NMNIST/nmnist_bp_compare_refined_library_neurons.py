...
def main():
    parser = argparse.ArgumentParser(description='NMNIST SNN + Backpropagation (BP) for comparison with FF')
    ...
    print(f'Validating NMNIST frame format: {tuple(sample_frame.shape)} label={sample_label}')
